...
# met une espace AVANT le guillemet fermant : "? »"). Ce groupe entier
# ("end") reste attaché à la phrase qui précède ; seul l'espace qui suit,
# avant le début de la phrase suivante (majuscule, chiffre, guillemet
# ouvrant...), sert de séparateur et disparaît.
_SENTENCE_BOUNDARY_RE = re.compile(
    r'(?P<end>(?:\.\.\.|[.!?…])(?:\s?[»”"\')])?)\s+(?=[A-ZÀ-ÖØ-Þ0-9«"“(\-])'
)
