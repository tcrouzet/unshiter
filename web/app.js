...
const DETAILS = [
  ["action_verb_ratio", "Verbes d’action", true], ["temporal_connector_ratio", "Connecteurs temporels", true], ["personal_subject_ratio", "Sujets personnels", true], ["narrativity_score", "Narrativité", true],
...
fetch("data.json?v=20260828133310509483000").then(r => r.json()).then(json => {
  data = json;
