...
Pourcentage de signes de ponctuation par mots. Un style très ponctué est plus haché, plus mitraillé ; un style moins ponctué implique un flot continu.

# Complexité de ponctuation / Simplicité de ponctuation #2

Répartition des signes de ponctuation en dix familles : point, virgule, point-virgule, deux-points, interrogation, exclamation, tiret, parenthèses, guillemets et points de suspension. Le calcul utilise l’entropie de cette répartition, ramenée entre 0 et 100 %. Une faible entropie indique l'usage de peu de ponctuation différente, par exemple seulement des points et des virgules, alors qu'une grande entropie implique un usage de tout l'arsenal disponible.
...
# Alternance des débuts de phrase / Régularité des débuts de phrase #5
...
Même proportion de trigrammes de lemmes distincts répétés, calculée dans des fenêtres glissantes de 200 mots espacées de 50 mots, puis moyennée. Cette version privilégie les formulations qui reviennent à proximité. Pour un texte de 200 mots ou moins, elle est identique à la répétition globale.
...
# Desités des Verbes / Sparcité des verbes #17
...
# Densité des adverbes / Spacité des adverbes #19
...
# Compressibilité gzip / Uncompressibilité gzip #21
...
# Densité de eelatives et subordonnées / Sparcité de relatives et subordonnées #22
...
# Densité de voix active / Densité de voix négative #24
...
Surface sur le graphique radar en fonction des valleurs affichées. C'est une signature stylistique et non un critère de qualité.
...
# Diversité locale de longueur de phrase / Régularité locale de longueurs de phrase #6
...
# Diversité de longueur de phrase / Uniformité de longueur de phrase #20
...
# Longueur moyenne des mots #33

Nombre moyen de caractères par mot dans le document analysé.

# Longueur moyenne des phrases #34

Nombre moyen de caractères par phrase dans le document analysé.

# Longueur moyenne des phrases #35

Nombre moyen de mots par phrase dans le document analysé.

# Longueur médiane des phrases #36

Longueur en caractères qui partage les phrases en deux groupes de même effectif.

# Longueur P10 des phrases #37
