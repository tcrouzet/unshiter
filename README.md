...
| IA | Somme de huit signaux normalisés. Ce résultat est un indice expérimental, pas une probabilité. Les bornes et les poids sont définis dans `config.py`. |
...
Poids actuels de l’indice IA : répétition des structures 20 %, faible diversité
des structures 15 %, faible variation relative des phrases 10 %, faible densité de ponctuation 15 %, faible diversité de
...
| Variation des phrases (mots) | Écart-type du nombre de mots par phrase. Pour l’indice IA, cette valeur est divisée par la longueur moyenne des phrases ; une faible variation relative augmente l’indice IA. |
...
| Répétitions non filtrée | Répétition des lemmes calculée en conservant les mots-outils. Cette valeur mesure aussi les répétitions grammaticales ordinaires. |
