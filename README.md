...
Les résultats, tableaux et graphiques sont consultables exclusivement sur [l’application web](https://tcrouzet.github.io/unshiter/). La liste ci-dessous documente les mesures disponibles.
...
Les BigFive synthétisent des familles de mesures complémentaires. Ils servent à comparer des profils stylistiques ; ils ne constituent ni un jugement de qualité ni une preuve d’origine humaine ou artificielle.
